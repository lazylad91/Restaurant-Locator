...
public class SearchMap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Restaurant Finder");
...
/*        tabLayout.addTab(tabLayout.newTab().setText("List").setIcon(R.mipmap.iconrecy));
        ...
        tabLayout.getTabAt(0).setIcon(R.mipmap.iconrecy);
        tabLayout.getTabAt(1).setIcon(R.mipmap.iconcard);
/*        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        restaurantList= (List<Restaurant>)bundle.getSerializable("restaurantList");
        ...
        if (id == R.id.action_Map) {
           ...
           Bundle bundle = new Bundle();
            if(selectedRestaurant!=null)
                bundle.putSerializable("selectedRestaurant", (Serializable) selectedRestaurant);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            // Return a PlaceholderFragment (defined as a static inner class below).
             if(position==0){
                return LocationListFragment.newInstance(restaurantList);
            }
           return LocationCardFragment.newInstance(restaurantList);
        }
